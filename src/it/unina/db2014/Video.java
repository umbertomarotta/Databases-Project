 ...
 * @author ADeLuca
 */
public class Video extends DBFrame1 {
   ...
   protected void premutoOK() {
      if (getPadre() != null) {
         if (this.bStar) getPadre().setProprietaPadre("PreferitiV", getTCodice().getText());
         if (this.bTag) getPadre().setProprietaPadre("TagV", getTCodice().getText());
         else getPadre().setProprietaPadre("Video", getTCodice().getText());
         dispose();
      }
   }
    ...
    */
    ...
    private void initComponents() {
        ...
        tBitrate = new javax.swing.JTextField();
        tRatio = new javax.swing.JTextField();
        ...
        tRisoluzione = new javax.swing.JComboBox();
        ...
        tCompressione.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "MPEG-2", "MPEG-4", "H.264", "MKV", "" }));
        ...
        tRisoluzione.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "360p", "720p", "1080p", "4K", "" }));
        tRisoluzione.setSelectedItem("");
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            ...
                            .add(layout.createSequentialGroup()
                                ...
                                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                                    .add(tRatio, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 385, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                    .add(layout.createSequentialGroup()
                                    ...
                                    .add(layout.createSequentialGroup()
                                        ...
                                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                                            ...
                                            .add(tRisoluzione, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 385, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                                    .add(layout.createSequentialGroup()
                                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(tBitrate, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jLabel14))
                .add(8, 8, 8)
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(tRatio, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jLabel15))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
...
//        tModelloDescrizione.setText("");
   ...
   protected void mostraDati() {
      try {
         ...
         tRisoluzione.setSelectedItem(rs.getString("RISOLUZIONE"));
         tCompressione.setSelectedItem(rs.getString("COMPRESSION"));
         tBitrate.setText(rs.getString("BITRATE"));
         tRatio.setText(rs.getString("RATIO"));
         super.mostraDati();
   ...
   protected PreparedStatement creaSelectStatement() {
      ...
      String ID = getTCodice().getText(),
        ...
        RISOLUZIONE = tRisoluzione.getSelectedItem().toString(),
        COMPRESSION = tCompressione.getSelectedItem().toString(),
        BITRATE = tBitrate.getText(),
        RATIO = tRatio.getText();
      Pattern pat;
      Matcher matc;
      int k = 1;
      ...
      if (BITRATE.length() > 0) {
         if (BITRATE.indexOf("%") >= 0) {
            query += "and FF.BITRATE like ? ";
         } else {
            query += "and FF.BITRATE = ? ";
         }
      }
      if (RATIO.length() > 0) {
         if (RATIO.indexOf("%") >= 0) {
            query += "and FF.RATIO like ? ";
         } else {
            query += "and FF.RATIO = ? ";
         }
      }
      ...
      try {
         ...
         if (BITRATE.length() > 0) {
            st.setString(k++, BITRATE);
         }
         if (RATIO.length() > 0) {
            st.setString(k++, RATIO);
         }
         if (PROPRIETARIOID.length() > 0) {
...
//   }
   ...
   protected PreparedStatement getComandoInserimento(Connection c)
      ...
      queryIns = "insert all into " + Database.schema + ".files (ID,"
              ...
              +" into " + Database.schema + ".video (FILEID,"
              + "RISOLUZIONE,COMPRESSION,BITRATE,RATIO) values(?,?,?,?,?) SELECT * FROM dual";
      ...
      st.setString(13, tRisoluzione.getSelectedItem().toString());
      st.setString(14, tCompressione.getSelectedItem().toString());
      st.setString(15, tBitrate.getText());
      st.setString(16, tRatio.getText());
      return st;
   }
   ...
   protected PreparedStatement getComandoAggiornamento(Connection c)
      ...
      queryUp = "update " + Database.schema + ".video set RISOLUZIONE=?,COMPRESSION=?,BITRATE=?,RATIO=? where FILEID=?";
      st = c.prepareStatement(queryUp);
      st.setInt(5, Integer.decode(getTCodice().getText()));
      st.setString(1, tRisoluzione.getSelectedItem().toString());
      st.setString(2, tCompressione.getSelectedItem().toString());
      st.setString(3, tBitrate.getText());
      st.setString(4, tRatio.getText());
      return st;
   }
   ...
   public static void main1(String args[]) {
    ...
    private javax.swing.JTextField tBitrate;
    ...
    private javax.swing.JTextField tRatio;
    private javax.swing.JComboBox tRisoluzione;
